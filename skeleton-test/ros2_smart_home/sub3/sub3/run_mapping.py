...
class Mapper(Node):
    ...
    def __init__(self):
        ...
        self.map_pub = self.create_publisher(OccupancyGrid, '/map2', 1)
...
def save_map(node):
    full_path="C:/Users/SSAFY/Desktop/project_git/S09P22A101/skeleton-test/ros2_smart_home/sub3/map.txt"
    print(full_path)
    f=open(full_path,'w')
    data=''
