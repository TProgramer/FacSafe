...
class astarLocalpath(Node):
    ...
    def timer_callback(self):
        ...
        if current_waypoint != -1 :    # current_waypoint가 -1이 아닌 경우(유효한 가장 가까운 웨이포인트를 찾은 경우)
        ...
        self.local_path_pub.publish(local_path_msg)   # 로컬 경로를 발행
